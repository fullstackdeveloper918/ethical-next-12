  ...
  return (
    <div className={Styles.pdf_desgin}>
      ...
      <div className={Styles.after_logo}>
        ...
        <ul>
          <li>Prices described in this estimate don't include taxes, duties (when applicable), and
            shipping.</li>
          <li>Shipping to one or multiple locations will be estimated by our team when after you let us you know the shipping addresses. You will be billed according to the price practiced at the time of shipping.</li>
          <li>Changes on the decoration methods will incur in price alterations in the estimate.</li>
          <li>Inventory availability cannot be guaranteed until order payment is made</li>
          <li>If the product selected isn't available we will find a similar product to replace it.</li>
          <br></br>
      ...
      <div className={Styles.product_secwrapper}>
          ...
          <div className={Styles.single_pdfpro}>
            ...
            <div className={Styles.content_wrap}>
              <h4>A great "back to school" gift, this 2-in-1 sandwich bag and placemat i...</h4>
    ...
    <div className={Styles.about_swagsec}>
      ...
      <label htmlFor='swift_swag'>Checking this box will override the date selected above to within 10 business days if you have gone through the Swift Swag process. Please note additional charges will apply.</label>
      <span></span>
      </div>
      <div>
